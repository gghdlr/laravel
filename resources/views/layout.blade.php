...
<html lang="en">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <main>
      <div class="container">
      @yield('content') <!--встроить часть кода сюда: 'content', в cantact.blade.php: смотреть web.php там метод передает информацию в main.contact который экстенд лэйаут и в определенную секцию вставлеят-->
      </div>
    </main>
  </body>
</html>