...
<form action="/article/{{$article->id}}" method = "post">
  ...
  @method("PUT")
    ...
    <input type="date" class="form-control" id="exampleInputPassword1" placeholder="Enter name" name = "date" value="{{$article->date}}">
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Enter desc" name = "desc" value="{{$article->desc}}">
  </div>
